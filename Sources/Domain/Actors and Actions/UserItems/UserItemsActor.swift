    ...
    SetupItemActor
{
    ...
    public required init(
        ...
        let logging = MessageLogging(provider: logging)
        let recording = EventRecording(provider: recording)
        ...
        self.favoriteService = FavoriteService(favoriteRepository, listRepository, logging)
